                ...
                <div class="row">
                    @if(!empty(get_static_option('guest_order_system_status')))
                        @if(!empty(Auth::guard('web')->user()))
                            @include('tenant.frontend.shop.checkout.partials.checkout_left_side')
                        @else
                    ...
                    @include('tenant.frontend.shop.checkout.partials.checkout_right_side')
                </div>
            </div>
        </div>
    @else
        @include('tenant.frontend.shop.cart.cart_empty')
    @endif
